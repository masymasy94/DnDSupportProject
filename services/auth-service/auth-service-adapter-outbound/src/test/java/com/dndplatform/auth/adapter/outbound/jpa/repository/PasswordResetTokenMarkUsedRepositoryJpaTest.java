...
class PasswordResetTokenMarkUsedRepositoryJpaTest {

    @Mock
    private PasswordResetPanacheRepository panacheRepository;

    private PasswordResetTokenMarkUsedRepositoryJpa sut;

    @BeforeEach
    void setUp() {
        sut = new PasswordResetTokenMarkUsedRepositoryJpa(panacheRepository);
    }
