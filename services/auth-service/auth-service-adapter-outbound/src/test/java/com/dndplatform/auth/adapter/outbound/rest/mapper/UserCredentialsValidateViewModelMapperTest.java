...
class UserCredentialsValidateViewModelMapperTest {

    private final UserCredentialsValidateViewModelMapper sut = Mappers.getMapper(UserCredentialsValidateViewModelMapper.class);
