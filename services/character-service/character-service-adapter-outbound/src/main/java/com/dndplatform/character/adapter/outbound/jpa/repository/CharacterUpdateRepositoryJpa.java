...
@ApplicationScoped
public class CharacterUpdateRepositoryJpa implements CharacterUpdateRepository, PanacheRepository<CharacterEntity> {
    ...
    public Character update(Long characterId, CharacterCreate input, ValidatedCompendiumData compendiumData,
        ...
        CharacterEntity entity = find("id = ?1 and userId = ?2", characterId, input.userId())
                .firstResultOptional()
