...
@ApplicationScoped
public class CharacterCreateMapper implements Function<CreateCharacterRequest, CharacterCreate> {

    @Override
    public CharacterCreate apply(CreateCharacterRequest request) {
