...
class CharacterCreateMapperTest {

    private CharacterCreateMapper sut;

    @BeforeEach
    void setUp() {
        sut = new CharacterCreateMapper();
    }

    @Test
    void shouldMapRequestToDomain(@Random CreateCharacterRequest request) {
    ...
    void shouldHandleNullSubObjects() {
        var abilityScores = AbilityScoresRequestBuilder.builder()
                ...
                .withCharisma(10)
                .build();
        var request = CreateCharacterRequestBuilder.builder()
                .withUserId(1L)
                .withName("TestChar")
                .withSpecies("Human")
