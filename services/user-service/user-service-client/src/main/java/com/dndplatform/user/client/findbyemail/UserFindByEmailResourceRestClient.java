package com.dndplatform.user.client.findbyemail;
...
@RequestScoped
public interface UserFindByEmailResourceRestClient extends UserFindByEmailResource {

    @Override
    @POST
    @Retry(delay = 100, delayUnit = ChronoUnit.MILLIS)
    @Path("")
    UserViewModel findByEmail(UserFindByEmailViewModel vm);
}
