...
class SpellFindByIdRepositoryImplTest {
    ...
    private SpellFindByIdRepositoryImpl sut;

    @BeforeEach
    void setUp() {
        sut = new SpellFindByIdRepositoryImpl(panacheRepository, mapper);
    }

    @Test
    void shouldReturnMappedSpell(@Random SpellEntity entity, @Random Spell expected) {
