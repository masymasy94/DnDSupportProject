...
class MagicItemFindByIdRepositoryImplTest {

    @Mock private MagicItemPanacheRepository panacheRepository;
    @Mock private MagicItemMapper mapper;
    private MagicItemFindByIdRepositoryImpl sut;

    @BeforeEach
    void setUp() {
        sut = new MagicItemFindByIdRepositoryImpl(panacheRepository, mapper);
    }

    @Test
    void shouldReturnMappedMagicItem(@Random MagicItemEntity entity, @Random MagicItem expected) {
