...
class BackgroundFindByIdRepositoryImplTest {
    ...
    private BackgroundFindByIdRepositoryImpl sut;

    @BeforeEach
    void setUp() {
        sut = new BackgroundFindByIdRepositoryImpl(panacheRepository, mapper);
    }
