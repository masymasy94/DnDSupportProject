...
class SkillFindByIdRepositoryImplTest {
    ...
    private SkillFindByIdRepositoryImpl sut;

    @BeforeEach
    void setUp() {
        sut = new SkillFindByIdRepositoryImpl(panacheRepository, mapper);
    }

    @Test
    void shouldReturnMappedSkill(@Random SkillEntity entity, @Random Skill expected) {
