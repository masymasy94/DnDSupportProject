...
class WeaponTypeFindByIdRepositoryImplTest {

    @Mock
    private WeaponTypePanacheRepository panacheRepository;

    @Mock
    private WeaponTypeMapper mapper;

    private WeaponTypeFindByIdRepositoryImpl sut;

    @BeforeEach
    void setUp() {
        sut = new WeaponTypeFindByIdRepositoryImpl(panacheRepository, mapper);
    }

    @Test
    void shouldReturnMappedWeaponType(@Random WeaponTypeEntity entity, @Random WeaponType expected) {
