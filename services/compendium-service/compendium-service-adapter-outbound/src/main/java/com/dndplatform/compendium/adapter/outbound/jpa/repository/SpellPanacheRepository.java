...
@ApplicationScoped
public class SpellPanacheRepository implements PanacheRepository<SpellEntity> {

    public long countFiltered(String query, Map<String, Object> params) {
        return count(query, params);
    }

    public List<SpellEntity> findFiltered(String query, Map<String, Object> params, Sort sort, int page, int pageSize) {
