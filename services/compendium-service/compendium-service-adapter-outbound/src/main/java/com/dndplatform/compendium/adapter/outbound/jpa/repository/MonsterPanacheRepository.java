...
@ApplicationScoped
public class MonsterPanacheRepository implements PanacheRepository<MonsterEntity> {

    public long countFiltered(String query, Map<String, Object> params) {
        return count(query, params);
    }

    public List<MonsterEntity> findFiltered(String query, Map<String, Object> params, Sort sort, int page, int pageSize) {
