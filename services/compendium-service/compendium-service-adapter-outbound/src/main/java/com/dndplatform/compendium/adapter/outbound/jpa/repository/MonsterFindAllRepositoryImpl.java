...
@ApplicationScoped
public class MonsterFindAllRepositoryImpl implements MonsterFindAllRepository {
    ...
    @Inject
    public MonsterFindAllRepositoryImpl(MonsterPanacheRepository panacheRepository, MonsterMapper mapper) {
