...
class LanguageFindByIdServiceImplTest {

    @Mock
    private LanguageFindByIdRepository repository;

    private LanguageFindByIdService sut;

    @BeforeEach
    void setUp() {
        sut = new LanguageFindByIdServiceImpl(repository);
    }
    ...
    void shouldFindLanguageById() {
        ...
        Language result = sut.findById(id);
    ...
    @Test
    void shouldThrowNotFoundExceptionWhenLanguageDoesNotExist() {
        int id = 999;
        ...
        assertThatThrownBy(() -> sut.findById(id))
                ...
                .hasMessageContaining("Language not found with id: " + id);
