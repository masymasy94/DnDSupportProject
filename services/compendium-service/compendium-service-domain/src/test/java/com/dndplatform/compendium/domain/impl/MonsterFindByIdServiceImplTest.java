...
class MonsterFindByIdServiceImplTest {

    @Mock
    private MonsterFindByIdRepository repository;

    private MonsterFindByIdService sut;

    @BeforeEach
    void setUp() {
        sut = new MonsterFindByIdServiceImpl(repository);
    }
    ...
    void shouldFindMonsterById() {
        ...
        Monster result = sut.findById(id);
    ...
    @Test
    void shouldThrowNotFoundExceptionWhenMonsterDoesNotExist() {
        int id = 999;
        ...
        assertThatThrownBy(() -> sut.findById(id))
                ...
                .hasMessageContaining("Monster not found with id: " + id);
