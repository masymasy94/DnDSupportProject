...
@Schema(description = "Paginated magic item list")
@Builder
public record PagedMagicItemViewModel(
        @Schema(description = "List of magic items")
        List<MagicItemViewModel> content,
