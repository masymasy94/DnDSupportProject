...
class ToolTypeFindAllIntegrationTest {
    ...
    void shouldReturnAllToolTypes() {
        given(repository.findAllToolTypes(any())).willReturn(List.of(new ToolType((short) 1, "Smith Tools", "Artisan")));
        ...
        .then()
            ...
            .body("size()", equalTo(1)).body("name", org.hamcrest.Matchers.hasItem("Smith Tools"));
    }
